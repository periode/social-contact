	...
	String[] fall = {
		  ...
		  Seasons(PApplet p) {
			...
			for(int i = 0; i < numberOfWaves; i++){
				...
				gA4[i] = new Gain(PolSys.ac, 1, p.random(0.2f, 0.8f));
				gA5[i] = new Gain(PolSys.ac, 1, p.random(0.2f, 0.8f));
				gB4[i] = new Gain(PolSys.ac, 1, p.random(0.2f, 0.8f));
				gC4[i] = new Gain(PolSys.ac, 1, p.random(0.2f, 0.8f));
				gC5[i] = new Gain(PolSys.ac, 1, p.random(0.2f, 0.8f));
				gD4[i] = new Gain(PolSys.ac, 1, p.random(0.2f, 0.8f));
				gE[i] = new Gain(PolSys.ac, 1, p.random(0.2f, 0.8f));
				gF[i] = new Gain(PolSys.ac, 1, p.random(0.2f, 0.8f));
				gG[i] = new Gain(PolSys.ac, 1, p.random(0.2f, 0.8f));
